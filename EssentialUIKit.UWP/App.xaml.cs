    ...
    public sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            if (ApiInformation.IsTypePresent("Windows.UI.ViewManagement.ApplicationViewTitleBar"))
            {
                ...
                if (titlebar != null)
                {
                    titlebar.BackgroundColor = Color.FromArgb(1, 39, 52, 112);
                    titlebar.ForegroundColor = Colors.White;
                    titlebar.ButtonBackgroundColor = Color.FromArgb(1, 39, 52, 112);
                }
            }
            ...
            if (rootFrame == null)
            {
                ...
                var assembliesToInclude = new List<Assembly>
                {
                    ...
                    typeof(Syncfusion.SfRating.XForms.UWP.SfRatingRenderer).GetTypeInfo().Assembly,
                    typeof(Syncfusion.SfRotator.XForms.UWP.SfRotatorRenderer).GetTypeInfo().Assembly,
                    typeof(Syncfusion.XForms.UWP.ComboBox.SfComboBoxRenderer).GetTypeInfo().Assembly,
                    typeof(Syncfusion.XForms.UWP.Buttons.SfRadioButtonRenderer).GetTypeInfo().Assembly,
