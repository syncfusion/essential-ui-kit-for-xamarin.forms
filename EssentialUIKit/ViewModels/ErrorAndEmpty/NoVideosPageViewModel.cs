...
namespace EssentialUIKit.ViewModels.ErrorAndEmpty
{
    ...
    public class NoVideosPageViewModel : BaseViewModel
    {
        ...
        private static NoVideosPageViewModel noVideosPageViewModel;
        ...
        /// </summary>
        public static NoVideosPageViewModel BindingContext =>
            noVideosPageViewModel = PopulateData<NoVideosPageViewModel>("errorAndEmpty.json");
