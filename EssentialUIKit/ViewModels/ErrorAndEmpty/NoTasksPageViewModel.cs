...
namespace EssentialUIKit.ViewModels.ErrorAndEmpty
{
    ...
    public class NoTasksPageViewModel : BaseViewModel
    {
        ...
        private static NoTasksPageViewModel noTasksPageViewModel;
        ...
        /// <summary>
        /// Gets or sets the value of no tasks page view model.
        /// </summary>
        public static NoTasksPageViewModel BindingContext =>
            noTasksPageViewModel = PopulateData<NoTasksPageViewModel>("errorAndEmpty.json");

        /// <summary>
        /// Gets or sets the ImagePath.
        /// </summary>
        [DataMember(Name = "noTasksImagePath")]
        ...
        /// </summary>
        [DataMember(Name = "noTasksContent")]
