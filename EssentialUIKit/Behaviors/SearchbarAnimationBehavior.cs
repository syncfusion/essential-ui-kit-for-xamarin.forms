...
namespace EssentialUIKit.Behaviors
{
    ...
    public class SearchBarAnimationBehavior : Behavior<SfButton>
    {
        ...
        /// </summary>
        /// <param name="sfButton">The borderlessEntry</param>
        protected override void OnAttachedTo(SfButton sfButton)
        {
            if (sfButton != null)
            {
                base.OnAttachedTo(sfButton);
                this.SfButton = sfButton;
                sfButton.BindingContextChanged += this.OnBindingContextChanged;
                sfButton.Clicked += this.SfButton_Clicked;
            }
        }
        ...
        /// </summary>
        /// <param name="sfButton">The borderlessEntry</param>
        protected override void OnDetachingFrom(SfButton sfButton)
        {
            if (sfButton != null)
            {
                base.OnDetachingFrom(sfButton);
                sfButton.BindingContextChanged -= this.OnBindingContextChanged;
                sfButton.Clicked -= this.SfButton_Clicked;
                this.SfButton = null;
            }
